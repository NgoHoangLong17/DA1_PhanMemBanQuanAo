...
public class ChiTietSpJpanel1 extends javax.swing.JPanel {
    ...
    private void lamMoi() {
        list = chiTietSpServiceImpl.getAll();
        listChatLieu = chiTietSpServiceImpl.getChatLieu();
        listNsx = chiTietSpServiceImpl.getNsx();
        listMauSac = chiTietSpServiceImpl.getMauSac();
        listDongSp = chiTietSpServiceImpl.getDongSp();
        listSanPham = chiTietSpServiceImpl.getSanPham();
        listSize = chiTietSpServiceImpl.getSize();
    }
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtTim, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        ...
        lblThongTinChiTiet.addTab("Thông tin chi tiết", jPanel1);
        ...
        lblThongTinChiTiet.addTab("Thuộc tính", jPanel2);
